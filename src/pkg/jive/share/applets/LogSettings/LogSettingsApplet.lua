...
-- table entry to please newMenuWindow
...
function logSettings(self, menuItem)
	...
	-- newMenuWindow returns window, menu however applet expects status
	-- enclosing call in parenthesis guarantees only first element is returned
