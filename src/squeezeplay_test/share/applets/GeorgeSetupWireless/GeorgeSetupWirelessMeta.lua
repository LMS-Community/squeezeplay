...
function registerApplet(meta)
	...
	meta:registerService("georgeSetupRegionShow")
	meta:registerService("georgeSetupScanShow")
	meta:registerService("georgeSetupNetworksShow")
	meta:registerService("georgeSetupConnectionType")
