...
#define SpAppVerName "SqueezePlay 7.8.0r300"
...
Source: {#SpAppSourcePath}..\..\Release\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: *.pdb,*.ilk,*.exp,*.lib,stdout.txt,stderror.txt,.svn
