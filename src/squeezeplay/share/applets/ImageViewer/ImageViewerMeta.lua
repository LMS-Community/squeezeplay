...
function defaultSettings(self)
	...
	defaultSetting["http.path"] = "http://www.uesmartradio.com/static/images/imageviewer/sbtouch.lst"

	if System:getMachine() == "baby" then
		defaultSetting["http.path"] = "http://www.uesmartradio.com/static/images/imageviewer/sbradio.lst"
	end

	if System:getMachine() == "jive" then
		defaultSetting["http.path"] = "http://www.uesmartradio.com/static/images/imageviewer/sbcontroller.lst"
	end
