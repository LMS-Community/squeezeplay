...
styles = {
	...
	-- window styles
	"button_list.menu.scrollbar",
	"button_list.text",
	"button_list.title.button_help",
	"button_list.title.setup",
	"button_list.title.text",
	"button_list.menu.item.arrow",
	"button_list.menu.item.check",
	"button_list.menu.item.region_XX",
	"button_list.menu.item.region_US",
	"button_list.menu.item.text",
	"button_list.menu.pressed.item.arrow",
	"button_list.menu.pressed.item.region_US",
	"button_list.menu.pressed.item.region_XX",
	"button_list.menu.pressed.item.text",
	"button_list.menu.selected.item.arrow",
	"button_list.menu.selected.item.check",
	"button_list.menu.selected.item.region_US",
	"button_list.menu.selected.item.region_XX",
	"button_list.menu.selected.item.text",
	...
	"one_button.menu.scrollbar",
	"one_button.text",
	"one_button.title.text",
	"one_button.menu.selected.item.arrow",
	"one_button.menu.selected.item.check",
	"one_button.menu.selected.item.icon",
	"one_button.menu.selected.item.text",
	"one_button.title.setup",
	"one_button.menu.pressed.item.arrow",
	"one_button.menu.pressed.item.text",
	...
	"track_list.menu.locked.itemChecked.arrow",
	"track_list.menu.locked.itemChecked.check",
	"track_list.menu.locked.itemChecked.text",
	"track_list.menu.pressed.item.arrow",
	"track_list.menu.pressed.item.text",
	"track_list.menu.pressed.itemChecked.arrow",
	"track_list.menu.pressed.itemChecked.check",
	"track_list.menu.pressed.itemChecked.text",
	"track_list.menu.selected.itemChecked.arrow",
	"track_list.menu.selected.itemChecked.check",
	"track_list.menu.selected.itemChecked.text",
