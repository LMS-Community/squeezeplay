...
function JiveMain:jiveMainNodes(globalStrings)
	...
	jiveMain:addNode( { id = 'advancedSettings', iconStyle = 'hm_advancedSettings', node = 'settings', noCustom = 1, text = _globalStrings:str("ADVANCED_SETTINGS"), weight = 110, titleStyle = 'settings', windowStyle = 'text_list' })
