...
function JiveMain:jiveMainNodes(globalStrings)
	...
	jiveMain:addNode( { id = 'settings', iconStyle = 'hm_settings', node = 'home', noCustom = 1, text = _globalStrings:str("SETTINGS"), weight = 105, titleStyle = 'settings' })
	jiveMain:addNode( { id = 'advancedSettings', iconStyle = 'hm_advancedSettings', node = 'settings', text = _globalStrings:str("ADVANCED_SETTINGS"), weight = 105, titleStyle = 'settings', windowStyle = 'text_list' })
