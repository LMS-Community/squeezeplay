...
function _setupCrossover(self)
	...
	os.execute('amixer sset "Audio Codec Digital Filter Control" 0')
	os.execute('amixer sset "Audio Effects Filter N0 Coefficient" 22555,65072')
	os.execute('amixer sset "Audio Effects Filter N1 Coefficient" 42981,65072')
	os.execute('amixer sset "Audio Effects Filter N2 Coefficient" 22555,65072')
	os.execute('amixer sset "Audio Effects Filter N3 Coefficient" 32767,32767')
	os.execute('amixer sset "Audio Effects Filter N4 Coefficient" 0,0')
	os.execute('amixer sset "Audio Effects Filter N5 Coefficient" 0,0')
	os.execute('amixer sset "Audio Effects Filter D1 Coefficient" 24546,24546')
	os.execute('amixer sset "Audio Effects Filter D2 Coefficient" 47149,47149')
	os.execute('amixer sset "Audio Effects Filter D4 Coefficient" 0,0')
	os.execute('amixer sset "Audio Effects Filter D5 Coefficient" 0,0')

--todo: investigate why setMixer not working (produces silence after enable)
...
function _enableCrossover(self)
	...
	os.execute('amixer sset "Audio Codec Digital Filter Control" 10')
