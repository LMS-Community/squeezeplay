/*
** $Id: lxplib.c 1980 2006-11-21 11:45:11Z titmuss $
...
/* ======================================================= */
/* luaL_findstring is not defined in lua 5.1               */
/* workaround is to define it here                         */
...
/* == end of section from lua-5.0.3/src/lauxclib.c === */ 
