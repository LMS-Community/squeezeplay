...
p:close()
x = X[1]
-- x.n == 4 in the original test, not sure why, only 3 parms are sent by
-- StartNamespaceDecl
assert(x[1] == "sn" and x[3] == "space" and x[4] == "a/namespace" and x.n == 3)
x = X[3]
assert(x[1] == "s" and x[3] == "a/namespace?a")
x = X[4]
assert(x[1] == "e" and x[3] == "a/namespace?a")
x = X[6]
-- x.n == 3 in the original test, not sure why, only 2 parms are sent by
-- EndNamespaceDecl
assert(x[1] == "en" and x[3] == "space" and x.n == 2)
